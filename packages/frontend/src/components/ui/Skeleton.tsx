...
function Skeleton({
  ...
  const baseClass = 'bg-bg-tertiary/30 rounded-lg animate-shimmer bg-[length:200%_100%] bg-gradient-to-r from-bg-tertiary/40 via-bg-hover/20 to-bg-tertiary/40';
