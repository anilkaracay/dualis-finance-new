  ...
  return (
    <section className="relative py-24 md:py-32 px-6">
      <div className="max-w-[1000px] mx-auto">
        ...
        <h2 className="font-display text-[clamp(2rem,4vw,3.5rem)] text-[var(--lp-text-primary)] tracking-[-0.02em] leading-[1.1] mb-16">
          ...
          {HOW_IT_WORKS.map((step, i) => (
            <div key={step.step} className="relative flex flex-col md:px-8 first:md:pl-0 last:md:pr-0">
              ...
              {i < HOW_IT_WORKS.length - 1 && (
                <div className="hidden md:block absolute top-0 right-0 h-full w-px border-l border-dashed border-[var(--lp-border-hover)]" />
              )}

              <span className="font-data text-[clamp(2rem,4vw,3rem)] text-[var(--lp-accent)] opacity-30 leading-none mb-4">
                {step.step}
              </span>
